...
window.onload = function () {
    iA = document.getElementById('a');
    iM = document.getElementById('m');
    iV = document.getElementById('V');
    iN = document.getElementById('N');
    iY = document.getElementById('Y');
    iA.value = 0.3 + '';
    iV.value = 35 + '';
    iY.value = 1 + '';
    iM.value = 5 + '';
    ...
    iA.oninput = iM.oninput = iV.oninput = iN.oninput = iY.oninput = function (e) {
    ...
    iA.onfocus = iM.onfocus = iV.onfocus = iN.onfocus = iY.onfocus = function (e) {
        var element = e.srcElement;
        document.getElementById('l_' + element.id).classList.add('focus');
    };
    iA.onblur = iM.onblur = iV.onblur = iN.onblur = iY.onblur = function (e) {
        var element = e.srcElement;
        document.getElementById('l_' + element.id).classList.remove('focus');
    };
    iA.onchange = iM.onchange = iV.onchange = iN.onchange = iY.onchange = function () {
        updateChart();
    };
...
function calculateData5(a, m, V, N) {
    var count = V;
    var dataPk = [];
    var dataPt = [];
    var dataPb = [];
